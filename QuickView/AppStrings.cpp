...
struct EN {
  ...
  static constexpr const wchar_t *Settings_Tooltip_HdrPeakPercentile = L"Discard extremely bright pixels to raise overall brightness (mpv default: 99.995%).";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_100 = L"100% (Absolute Peak)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_99995 = L"99.995% (Stable)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_999 = L"99.9% (Aggressive)";
...
struct CN {
  ...
  static constexpr const wchar_t *Settings_Tooltip_HdrPeakPercentile = L"丢弃极少数过亮的像素以提升整体亮度 (mpv 默认: 99.995%).";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_100 = L"100% (绝对峰值)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_99995 = L"99.995% (稳定)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_999 = L"99.9% (激进)";
...
struct TW {
  ...
  static constexpr const wchar_t *Settings_Label_HdrPeakPercentile = L"HDR 峰值百分位";
  static constexpr const wchar_t *Settings_Tooltip_HdrPeakPercentile = L"丟棄極少數過亮的像素以提升整體亮度 (mpv 預設: 99.995%).";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_100 = L"100% (絕對峰值)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_99995 = L"99.995% (穩定)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_999 = L"99.9% (激進)";
...
struct JA {
  ...
  static constexpr const wchar_t *Settings_Tooltip_HdrPeakPercentile = L"極端に明るいピクセルを除外して全体を明るくします (mpvのデフォルト: 99.995%)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_100 = L"100% (絶対ピーク)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_99995 = L"99.995% (安定)";
  static constexpr const wchar_t *Settings_Option_HdrPeakPercentile_999 = L"99.9% (積極的)";
