...
namespace QuickView {
    ...
    RarArchive::SolidState::SolidState() {
        arc = new ::Archive();
        dataIO = new ::ComprDataIO();
    }
    ...
    void RarArchive::SolidState::Reset(const uint8_t* data, size_t size) {
        delete unpack;
        unpack = nullptr;
    ...
    RarArchive::~RarArchive() {
        // m_solidState unique_ptr handles cleanup
    }
